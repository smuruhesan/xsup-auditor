...
This repository contains the browser source, bookmark distribution, and documentation for XSUP Auditor & KCS Generator.
...
| `docs/KNOWLEDGE_QUALITY.md` | Knowledge classification, generation, quality review, review markers and readiness model |
| `docs/TECHNICAL_GUIDE.md` | Architecture, API/workflow behavior, reuse and maintainer invariants |
